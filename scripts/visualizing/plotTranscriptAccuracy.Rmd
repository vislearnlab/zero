---
title: "Plot ZERO object description accuracy data"
...
Load the transcript accuracy file
```{r}
...
Explore top and bottom accuracy scores - are they sensible?
...
Plot all the accuracy values, by object ID
...
```
Plot all the accuracy values, by subject ID
...
```
Are longer transcripts calculated as more accurate? 
